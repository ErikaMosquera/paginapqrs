...
class AutenticaController extends Controller
{
    public function registro(Request $request)
    {
        ...
        $user = User::create([
            ...
            'rol' => 'admin' // Establecer el rol como "admin" para usuarios registrados con el rol de administrador
        ]);
    ...
    public function logout(Request $request)
    {
        ...
        return redirect()->route('inicio')->with('info', 'Sesión cerrada correctamente');
    }
    ...
    {
        // Aquí se puede agregar la lógica para verificar si el usuario está autenticado, si es necesario.
