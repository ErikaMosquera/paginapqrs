        ...
        <div class="card-body">
            ...
            <form action="{{route('registro.store')}}" method="POST">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="name" placeholder="Escriba su nombre completo" maxlength="255" class="input input-sm input-bordered" required autofocus value="{{old('name')}}" />
                </div>
                {{-- Email --}}
                <div class="form-control">
                ...
                <div class="form-control">
                    ...
                    <input type="password" name="password" placeholder="Mínimo 5 caracteres, incluya símbolo o número" maxlength="45" class="input input-sm input-bordered" required />
                </div>
                ...
                <div class="form-control">
                    ...
                    <select name="role" class="input input-sm input-bordered" required>
                ...
                <div class="form-control">
                    <label class="label" for="address">
                        <span class="label-text">Dirección de notificación </span>
                    </label>
                    <input type="text" name="address" placeholder="Escriba la dirección para envíos" maxlength="255" class="input input-sm input-bordered" value="{{old('address')}}" />
                </div>
                {{-- Botones --}}
